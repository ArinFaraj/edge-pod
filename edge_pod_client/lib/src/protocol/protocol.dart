...
class Protocol extends _isc.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == List<_ijewskhe.Note>) {
      return (data as List).map((e) => deserialize<_ijewskhe.Note>(e)).toList()
          as T;
    }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is Map<String, dynamic> && data['__className__'] is String) {
      return (data['__className__'] as String).replaceFirst('edge_pod.', '');
    }
