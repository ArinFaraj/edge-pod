...
import 'package:edge_pod_client/src/protocol/notes/note.dart' as _ijewskhe;
...
class EndpointNote extends _isc.EndpointRef {
  ...
  _ida.Future<_ijewskhe.Note> create(
    String title,
    String? content,
  ) => caller.callServerEndpoint<_ijewskhe.Note>(
    'note',
    'create',
    {
      'title': title,
  ...
  _ida.Future<List<_ijewskhe.Note>> list() =>
      caller.callServerEndpoint<List<_ijewskhe.Note>>(
        'note',
        'list',
        {},
      );

  _ida.Future<_ijewskhe.Note?> toggle(int id) =>
      caller.callServerEndpoint<_ijewskhe.Note?>(
        'note',
        'toggle',
        {'id': id},
