...
INSERT INTO "serverpod_sqlite_schema" VALUES
    ('note', 'isCompleted', 'boolean', NULL),
    ('note', 'createdAt', 'timestampWithoutTimeZone', NULL),
...
--
-- MIGRATION VERSION FOR edge_pod
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('edge_pod', '20260916214952113', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260916214952113', "timestamp" = (unixepoch('now', 'subsecond') * 1000);
