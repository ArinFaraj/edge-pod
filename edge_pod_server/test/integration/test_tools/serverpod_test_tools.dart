...
import 'package:edge_pod_server/src/generated/notes/note.dart' as _is7xosxb;
import 'package:serverpod/serverpod.dart' as _is;
import 'package:serverpod_test/serverpod_test.dart' as _ist;
import 'package:edge_pod_server/src/generated/protocol.dart';
import 'package:edge_pod_server/src/generated/endpoints.dart';
...
class _NoteEndpoint {
  ...
  _ida.Future<_is7xosxb.Note> create(
  ...
  _ida.Future<List<_is7xosxb.Note>> list(
    _ist.TestSessionBuilder sessionBuilder,
  ) async {
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _ida.Future<List<_is7xosxb.Note>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _ida.Future<_is7xosxb.Note?> toggle(
    _ist.TestSessionBuilder sessionBuilder,
    int id,
  ) async {
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
